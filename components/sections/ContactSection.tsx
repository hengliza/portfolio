  ...
  return (
    <section id="contact" className="bg-primary text-primary-foreground">
      <div className="mx-auto max-w-6xl px-5 py-24 md:px-8 md:py-32">
        <span className="section-kicker text-primary-foreground">05 — Contact</span>
        ...
        <div className="mt-12 flex items-center justify-end gap-4">
          <a href={pageCopy.github} target="_blank" rel="noopener noreferrer">
            <Image
              src="/Images/githubImg.png"
              alt="GitHub"
              width={30}
              height={30}
          ...
          <a href={pageCopy.telegram} target="_blank" rel="noopener noreferrer">
            <Image
        ...
        <div className="mt-4 flex justify-between border-t border-primary-foreground/25 pt-5 font-mono text-[10px] uppercase tracking-[0.16em] text-primary-foreground/70">
